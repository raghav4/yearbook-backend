...
router.post('/user/signup', [ adminAuth, validator(Validation.signup) ],
...
router.patch('/user/update-profile-picture', [ userAuth ],
...
router.post('/answer/new', [ userAuth, validator(Validation.answer) ],
            Controller.upsertAnswer);

// Route to delete an answer for the logged-in user.
router.delete('/answer/delete/:id', [ userAuth, validateObjectId ],
...
router.get('/message/:id', [ userAuth, validateObjectId ],
           Controller.getMessageByReceiverId);

// Route to update a message
router.put('/message/new', [ adminAuth, validator(Validation.message) ],
           Controller.updateMessage);

// Route to delete a message
router.delete('/message/delete/:id', [ userAuth, validateObjectId ],
...
router.get('/question/:id', [ userAuth, validateObjectId ],
           Controller.getSlambookQuestionById);

// Route to create a new question.
router.post('/question/new', [ userAuth, validator(Validation.title) ],
            Controller.createSlambookQuestion);

// Route to delete a question
router.delete('/question/delete/:id', [ userAuth, validateObjectId ],
...
router.post('/poll/new', [ adminAuth, validator(Validation.title) ],
            Controller.createPoll);

// Route to delete a poll by pollId
router.delete('/poll/delete/:id', [ userAuth, validateObjectId ],
